            ...
            : myWorld(aWorld)
{
    ...
    for (int i = 0; i < 10; i++)
    {
        ...
        body2->CreateFixture(&dropboxShape2, 0.05f)->SetUserData((UserData*)this);
        ...
        if (i != 0)
        {
            ...
            b2RevoluteJoint* joint = (b2RevoluteJoint*)aWorld.CreateJoint(&jointDef);
                ...
                b2Contact*			contact)
{
    ...
    if (contact->GetFixtureA()->GetUserData() == (UserData*)this)
    {
        ((UserData*)contact->GetFixtureB()->GetUserData())->TouchedRope(this, contact->GetFixtureA()->GetBody());
    }

    if (contact->GetFixtureB()->GetUserData() == (UserData*)this)
    {
        ((UserData*)contact->GetFixtureA()->GetUserData())->TouchedRope(this, contact->GetFixtureB()->GetBody());
    }
}
